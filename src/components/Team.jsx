...
import member3 from "../assets/member2.jpeg";
// import member4 from "../assets/team/pooja.jpg";
...
const team = [
  ...
  { num: '02', img: member2, avatarColor: 'pink', name: 'Tarun', role: 'Creative Director', bio: 'Reels-first brain. Ex-agency. Trend whisperer. Makes brands feel alive on the timeline.', pink: true },
  { num: '03', img: member3, avatarColor: 'green', name: 'Sathwik', role: 'Influencer Partnerships', bio: '500+ creator network. Campaign architect. Believes authentic > reach, always.', pink: false },
  // { num: '04', img: member4, avatarColor: 'pink', name: 'Pooja P.', role: 'Performance Marketing', bio: 'Meta & Google certified. ROAS obsessed. Data with a creative soul.', pink: true },
]
